...
/* OBI is a C ABI-first spec. Headers in this repo define the normative layout and
 * naming for hosts/providers. This is a reference artifact, not an implementation.
 */
